...
const Home = () => {
  ...
  const formSubmit = (e) => {
    e.preventDefault();
    // alert(
    //   `My name is ${data.email}. My mobile number Here is what I watn to say ${data.password}`
    // );
    ...
    <>
      <form onSubmit={formSubmit}>
        ...
        <div className="imgContainer">
          <img
            src="https://a2d.co.in/wp-content/uploads/2022/01/cropped-SQ-Black-512x512-1.jpg"
            alt="avatar"
            className="avatar"
          />
        </div>
